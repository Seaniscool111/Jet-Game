...
move_up_sound = pygame.mixer.Sound("Rising.mp3")

# Flying Down
# Sound Source: https://pixabay.com/sound-effects/launching-jet-plane-332969/
move_down_sound = pygame.mixer.Sound("Falling.mp3")
...
jet_startup = pygame.mixer.Sound("Jet_EngineStartUp.mp3")
...
font = pygame.font.Font(custom_font_path, 48)

# Loading High Score
high_score = load_high_score()
print("Loaded high score:", high_score)
score_font = pygame.font.Font(custom_font_path, 32)
level_font = pygame.font.Font(custom_font_path, 24)
